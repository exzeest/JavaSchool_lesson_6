...
public class BeanUtils {
    ...
    public static void assign ( Object to, Object from ) {
        ...
        Method[] publicMethodsFrom = fromClass.getMethods ();
        Method[] publicMethodsTo = toClass.getMethods ();
        for (Method methodFrom : publicMethodsFrom) {
            if (methodFrom.getName ().startsWith ("get"))
                for (Method methodTo : publicMethodsTo) {
                    if (methodTo.getName ().startsWith ("set"))
                        if ((methodFrom.getReturnType () == methodTo.getParameterTypes ()[0]
                            ...
                            try {
                                methodTo.invoke (to, methodFrom.invoke (from, new Object[]{}));
